...
describe("Testing moveFirstAndLastItems()", () => {
    ...
    it("Should handle multiple inputs", () => {
        expect(moveFirstAndLastItems(items)).toEqual([
            "Pear",
            "Apple",
            "Orange",
        ]);
...
describe("Testing removeEvenNumbers()", () => {
  ...
  it("Should be defined", () => {
    ...
    it("Should remove even numbers from a small array", () => {
        ...
        expect(removeEvenNumbers([1553445, 442, 23313])).toEqual([
            1553445,
            23313,
        ]);
    });
...
describe("Testing generateHighscores()", () => {
    ...
    it("Should catch invalid parameters.", () => {
        players.pop();
        expect(generateHighscores(players, playerScores)).toBe(
            "invalid inputs",
        );
    ...
    it("Should return a new Array", () => {
        ...
        expect(generateHighscores(players, playerScores)).not.toBe(
            playerScores,
        );
    });
});
