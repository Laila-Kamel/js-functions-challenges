...
describe("Testing createListOfPoessessions()", () => {
  ...
  it("Should return an array", () => {
    ...
    it("Should match given Array's length", () => {
        ...
        expect(
            createListOfPoessessions(Array(20).fill("A"), "disco").length,
        ).toBe(20);
    });
});
...
describe("Testing convertStringToNumbersArray()", () => {
  ...
  it("Should return an array", () => {
    ...
    it("Should convert string as expected", () => {
        ...
        expect(
            convertStringToNumbersArray(Array(10).fill("1").join("+")),
        ).toEqual(Array(10).fill(1));
    });

    it("Should handle big inputs", () => {
        expect(
            convertStringToNumbersArray(Array(100).fill("1").join("+")),
...
describe("Testing filterBooksBySearch()", () => {
  ...
  it("Should return an array", () => {
    ...
    it("Should handle large matches", () => {
        expect(
            filterBooksBySearch(Array(100).fill("disco"), "disco").length,
        ).toBe(100);
    });

    it("Should handle single character matches", () => {
        expect(
            filterBooksBySearch(["a", "aa", "bb", "aaa", "b"], "a").length,
        ).toBe(3);
        expect(
            filterBooksBySearch(["a", "aa", "bb", "aaa", "b"], "b").length,
        ).toBe(2);
    });

    it("Should handle no matches", () => {
        expect(
            filterBooksBySearch(Array(100).fill("disco"), "techno").length,
        ).toBe(0);
...
describe("Testing formatStringArray()", () => {
  it("Should return a String", () => {
    ...
    it("Should format multiple strings as expected", () => {
        ...
        expect(formatStringArray(cleanedStrings.split("+"))).toBe(
            cleanedStrings,
        );
    });
});
...
describe("Testing formatString()", () => {
  it("Should NOT return undefined", () => {
    ...
    it("Should remove punctuation", () => {
        expect(
            formatString("punctuation!\"£$%^&*()?[]{}|,./;'@~#+=").length,
        ).toBe(11);
